...
const NewsLetterPreviewerDarkular = (props) => {
    ...
    return `<table ondragend='handleDragEnd(event)' ondragleave='handleDragLeave(event)' ondrop="handleDrop(event)" ondragover="handleDragOver(event)" style="width: 100%; max-width: 650px; border-spacing: 0; background-color: rgb(0, 41, 59);">
        <tbody>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    <div class="nl-focusable-container-elem" tabindex="-1" 
                        style="display: flex; align-items: center; justify-content: center; background-color: #003D4D; padding: 25px 20px;">
                        <div class="nl-focusable-container-elem" tabindex="-1">
...
export default NewsLetterPreviewerDarkular;