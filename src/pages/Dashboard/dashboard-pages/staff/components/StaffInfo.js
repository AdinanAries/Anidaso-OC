    ...
    return <div>
            <div style={{display: "flex", margin: 10}}>
                ...
                <div 
                    ...
                    <i style={{color: "yellow", marginRight: 10}} className="fa fa-user"></i>
                    Info
                ...
                <div 
                    ...
                    <i style={{color: "rgba(255,255,255,0.5)", marginRight: 10}} className="fa fa-link"></i>
                    Links
                    <div style={{marginTop: 10, borderRadius: 100}}></div>
                </div>
                <div 
                    style={{padding: "20px 15px", paddingBottom: 10, color: "rgba(255,255,255,0.5)", cursor: "pointer", fontSize: 12, }} >
                    <i style={{color: "rgba(255,255,255,0.5)", marginRight: 10}} className="fa fa-users"></i>
                    customers
                    <div style={{marginTop: 10, borderRadius: 100}}></div>
                </div>
                <div 
                ...
                <div 
                    style={{padding: "20px 15px", paddingBottom: 10, color: "rgba(255,255,255,0.5)", cursor: "pointer", fontSize: 12, }} >
                    <i style={{color: "rgba(255,255,255,0.5)", marginRight: 10}} className="fa fa-wallet"></i>
                    wallet
                    <div style={{marginTop: 10, borderRadius: 100}}></div>
                </div>
            </div>
